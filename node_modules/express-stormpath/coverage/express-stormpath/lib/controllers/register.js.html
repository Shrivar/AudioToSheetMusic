...
<html lang="en">
<head>
    <title>Code coverage report for express-stormpath/lib/controllers/register.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">express-stormpath/lib/controllers/register.js</span></h1>
    <h2>
        Statements: <span class="metric">88.04% <small>(81 / 92)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">71.21% <small>(47 / 66)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(21 / 21)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">88.04% <small>(81 / 92)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">express-stormpath/lib/controllers/</a> &#187; register.js</div>
</div>
<div class="body">
...
&nbsp;
            if (config.web.register.autoLogin) {
              return authenticator.authenticate({
                username: req.body.email || <span class="branch-1 cbranch-no" title="branch not covered" >uuid(),</span>
                password: req.body.password || <span class="branch-1 cbranch-no" title="branch not covered" >uuid()</span>
              }, function(err, passwordGrantAuthenticationResult) {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >                  return res.status(400).json({ errors: [new Error(err.userMessage || err.message)] });</span>
                }
                helpers.createSession(passwordGrantAuthenticationResult, expandedAccount, req, res);
                <span class="missing-if-branch" title="else path not taken" >E</span>if (postRegistrationHandler) {
                  return postRegistrationHandler(expandedAccount, req, res, defaultJsonResponse.bind(null,req,res));
                }
<span class="cstat-no" title="statement not covered" >                defaultJsonResponse(req,res);</span>
              });
            }
&nbsp;
...
&nbsp;
  ...
  // chrome / firefox / etc.).
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (accepts === 'html') {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (req.method !== 'POST') {
<span class="cstat-no" title="statement not covered" >      return res.status(415).end();</span>
    }
&nbsp;
...
&nbsp;
      ...
      function(callback) {
        helpers.prepAccountData(req.body, config, function(accountData) {
          application.createAccount(accountData, function(err, account) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >              logger.info('A user tried to create a new account, but this operation failed with an error message: ' + err.developerMessage);</span>
...
<span class="cstat-no" title="statement not covered" >        return helpers.render(req, res, view, { errors: [new Error(err.userMessage)], form: helpers.sanitizeFormData(req.body, config) });</span>
      }
...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (postRegistrationHandler) {
<span class="cstat-no" title="statement not covered" >            return postRegistrationHandler(expandedAccount, req, res, defaultUnverifiedHtmlResponse.bind(null,config,res));</span>
          }
...
<span class="cstat-no" title="statement not covered" >    res.status(415).end();</span>
  }
};
&nbsp;</pre></td></tr>
</table></pre>
