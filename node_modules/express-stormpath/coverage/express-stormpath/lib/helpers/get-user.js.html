...
<html lang="en">
<head>
    <title>Code coverage report for express-stormpath/lib/helpers/get-user.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">express-stormpath/lib/helpers/get-user.js</span></h1>
    <h2>
        Statements: <span class="metric">69.83% <small>(81 / 116)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">73.33% <small>(44 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(15 / 15)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">69.83% <small>(81 / 116)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">express-stormpath/lib/helpers/</a> &#187; get-user.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >          logger.info('Failed to expand the user\'s account.');</span>
...
&nbsp;
          refreshGrantResponse.getAccount(function(err, account) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >              logger.info('Failed to get account from refreshGrantResponse.');</span>
<span class="cstat-no" title="statement not covered" >              return next();</span>
            }
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (account.status !== 'ENABLED') {
<span class="cstat-no" title="statement not covered" >              logger.info('Account for refresh_token cookie is not ENALBED.');</span>
<span class="cstat-no" title="statement not covered" >              return next();</span>
            }
&nbsp;
            expandAccount(req.app, account, function(err, expandedAccount) {
...
&nbsp;
              ...
              req.user = expandedAccount;
&nbsp;
              <span class="missing-if-branch" title="if path not taken" >I</span>if (refreshGrantResponse.grantedScopes) {
<span class="cstat-no" title="statement not covered" >                res.locals.permissions = refreshGrantResponse.grantedScopes;</span>
<span class="cstat-no" title="statement not covered" >                req.user = expandedAccount;</span>
<span class="cstat-no" title="statement not covered" >                req.permissions = refreshGrantResponse.grantedScopes;</span>
              }
&nbsp;
...
&nbsp;
      ...
      authenticationResult.getAccount(function(err, account) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >          logger.info('Failed to get account ' + authenticationResult.account.href);</span>
<span class="cstat-no" title="statement not covered" >          return next();</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (account.status !== 'ENABLED') {
<span class="cstat-no" title="statement not covered" >          logger.info('Account for access_token cookie is not ENALBED.');</span>
<span class="cstat-no" title="statement not covered" >          return next();</span>
        }
&nbsp;
        expandAccount(req.app, account, function(err, expandedAccount) {
...
&nbsp;
          ...
          req.user = expandedAccount;
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (authenticationResult.grantedScopes) {
<span class="cstat-no" title="statement not covered" >            res.locals.permissions = authenticationResult.grantedScopes;</span>
<span class="cstat-no" title="statement not covered" >            req.user = expandedAccount;</span>
<span class="cstat-no" title="statement not covered" >            req.permissions = authenticationResult.grantedScopes;</span>
          }
&nbsp;
          next();
        });
...
&nbsp;
      result.getAccount(function(err, account) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >          logger.info('Failed to get account.');</span>
<span class="cstat-no" title="statement not covered" >          return next();</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (account.status !== 'ENABLED') {
<span class="cstat-no" title="statement not covered" >          logger.info('Account is not ENALBED.');</span>
<span class="cstat-no" title="statement not covered" >          return next();</span>
        }
&nbsp;
        expandAccount(req.app, account, function(err, expandedAccount) {
