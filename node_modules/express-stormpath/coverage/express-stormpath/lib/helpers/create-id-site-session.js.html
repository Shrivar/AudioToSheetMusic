...
<html lang="en">
<head>
    <title>Code coverage report for express-stormpath/lib/helpers/create-id-site-session.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">express-stormpath/lib/helpers/create-id-site-session.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">express-stormpath/lib/helpers/</a> &#187; create-id-site-session.js</div>
</div>
<div class="body">
...
&nbsp;
  cookies.set('idSiteSession', account.href, {
    ...
    secure: (refreshTokenCookieConfig.https !== null ? refreshTokenCookieConfig.https : (<span class="branch-1 cbranch-no" title="branch not covered" >req.protocol === 'https')</span>)
  });
};
&nbsp;</pre></td></tr>
</table></pre>
